...
class ScanResult(db.Model):
    ...
    marketplace_card_id = db.Column(db.Integer, db.ForeignKey('marketplace_card.id', name='fk_ScanResult_marketplace_card_id'), nullable=False)
    ...
    marketplace_card = db.relationship('MarketplaceCard', back_populates='scan_results')
