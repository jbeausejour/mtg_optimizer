...
class TestCardDataManager(unittest.TestCase):
    ...
    def test_get_scryfall_card_versions(self, mock_get):
        ...
        mock_get.return_value.json.return_value = {
            'data': [
                {'set': 'lea', 'set_name': 'Limited Edition Alpha', 'lang': 'en', 'finishes': ['nonfoil']},
                {'set': '4ed', 'set_name': 'Fourth Edition', 'lang': 'en', 'finishes': ['nonfoil']},
                {'set': 'clb', 'set_name': "Commander Legends: Battle for Baldur's Gate", 'lang': 'en', 'finishes': ['foil', 'nonfoil']}
            ],
            'has_more': False
        }
