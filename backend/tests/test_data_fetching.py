...
class TestExternalDataSynchronizer(unittest.TestCase):
    ...
    def test_extract_info(self, mock_clean_card_name, mock_parse_card_string):
        ...
        result = ExternalDataSynchronizer.extract_info(self.soup, self.site, self.card_names, strategy=ExternalDataSynchronizer.STRATEGY_SCRAPPER)
    ...
    def test_save_cards_to_db(self, mock_scan_result, mock_marketplace_card, mock_scan, mock_session):
    ...
    @patch('app.utils.data_fetcher.parse_card_string')
    @patch('app.utils.data_fetcher.clean_card_name')
    def test_extract_info_no_matching_cards(self, mock_clean_card_name, mock_parse_card_string):
        mock_parse_card_string.return_value = {
    ...
    def test_extract_info_empty_soup(self):
        ...
        result = ExternalDataSynchronizer.extract_info(empty_soup, self.site, self.card_names, strategy=ExternalDataSynchronizer.STRATEGY_SCRAPPER)
    ...
    def test_process_product_item(self, mock_clean_card_name, mock_parse_card_string):
        ...
        result = ExternalDataSynchronizer.process_product_item(item, site, card_names, excluded_categories)
